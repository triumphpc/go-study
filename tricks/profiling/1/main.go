...
//https://github.com/ardanlabs/gotraining/blob/master/topics/go/profiling/stack_trace/README.md
...
/*
    ...
    Slice Value:      0xc000042748, 0x2, 0x4 - there we have length 2 and capacity 4
    String Value:     0x106abae, 0x5 - length 5
    Integer Value:    0xa
